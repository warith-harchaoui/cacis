...
\begin{enumerate}[leftmargin=1.2em, itemsep=0.2em, topsep=0.2em]
  ...
  \item \textbf{Deployable software.} We release a modular PyTorch implementation, a Docker image, an AWS launcher, and a cost-aware inference utility, so practitioners can swap $\mC$ for their own decision geometry.
\end{enumerate}
